...
$(document).ready(function () {
	...
	var toMiddle = '45%';
	var fromTop = "20px";
	var fromTopSecond = '250px';
	var fromTopThird = '480px';
	var squareWidth = '220';
	var squareHeight = '220'; 
	var fromRight = "100%";
	var fontSize;
	var backButtonWidth;
	...
	var amproFromLeft;
	var dennysFromLeft;
	var redlobsterFromLeft;
	var mastersFromLeft;
	var html5css3FromLeft;
	var rubyonrailsFromLeft;
	var postgresqlLogo;	
	var lineWidth = '40%';
	var textWidth = '40%';
	...
	function setupUI() {
		...
		intelFromLeft = (squareWidth + 20 + "px");
		amproFromLeft = (squareWidth + 140 + "px");
		dennysFromLeft = (squareWidth + 20 + "px");
		redlobsterFromLeft = (squareWidth + 240 + "px");		
		mastersFromLeft = (squareWidth + 20 + "px");
		html5css3FromLeft = (squareWidth + 20 + "px");
		rubyonrailsFromLeft = (squareWidth + 20 + "px");
		postgresqlFromLeft = (squareWidth + 140 + "px");
		...
		$(".intelLogo").css("left", intelFromLeft);
		$(".amproLogo").css("left", amproFromLeft);
		$(".dennysLogo").css("left", dennysFromLeft);
		$(".redlobsterLogo").css("left", redlobsterFromLeft);
		$(".mastersLogo").css("left", mastersFromLeft);
	}
	...
	*/
	...
	$(".picture").click(function () {
		...
		$(".line").animate({opacity:'1.0', width:lineWidth},800);
	...
	$(".experience").click(function () {
		...
		var text = "<strong><div class='experienceTextHeading'>EXPERIENCE</div></strong><br>Looking for some of the work experience I have had? You've come to the right place!<br><br>" +
	...
	$(".education").click(function () {
		...
		"More information can be found at <a href='www.wascsenior.org'>www.wascsenior.org</a><br><img src='/assets/wasc.png'><br>" +
	...
	//Website clicked
	$(".website").click(function () {$(".website").animate({top:fromTop},400);$(".website").animate({left:fromLeft},800);
		$(".back").animate({opacity:'1.0'},1600, websiteClicked());$(".back").css("visibility", "visible");
		
		$(".html5css3Logo").animate({opacity:'1.0'},1600);$(".html5css3Logo").css("visibility", "visible");
		$(".html5css3Logo").css("left", html5css3FromLeft);$(".rubyonrailsLogo").animate({opacity:'1.0'},1600);
		$(".rubyonrailsLogo").css("visibility", "visible");$(".rubyonrailsLogo").css("left", rubyonrailsFromLeft);

		$(".postgresqlLogo").animate({opacity:'1.0'},1600);$(".postgresqlLogo").css("visibility", "visible");
		$(".postgresqlLogo").css("left", postgresqlFromLeft);		
		$(".line").animate({opacity:'1.0', width:lineWidth},800);$(".line").css("visibility", "visible");
		...
		websiteNode = document.getElementsByClassName('text');websiteNode[0].innerHTML = text;
	...
	$(".resume").click(function () {
		...
		"Download it in PDF form <a href='https://drive.google.com/file/d/0BzrB09qIhz5_clVmUGNGYXdVbEE/edit?usp=sharing' target='new'>here</a>.";
